...
public class LipSyncManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Import configuration from XML"))
        {
            ImportXML();
        }
    }
    ...
    void ImportXML()
    {
        lipSyncInstance.PopulateBlendshapeList();
        lipSyncInstance.PhonemeBlendShapeMapping();
        lipSyncInstance.DiphoneMapping();
        lipSyncInstance.EmotionBlendShapeMapping();
